...
flowchart TD
    ...
    NodeIn2 --> Step2
    NodeRef -.-> Step2
    Step2["<div style='font-size: 19px; font-weight: 700; color: #DC2626 !important; margin-bottom: 6px;'>Step 2 · Spotting the Typos</div><div style='font-size: 14px; color: #374151;'>Aligns reads and mathematically subtracts healthy DNA from tumor DNA to isolate somatic mutations.<br><b>Software:</b> GATK Mutect2</div>"]
    Step2 --> NodeIn3
    ...
    NodeHLA -.-> Step3
    NodeIn3 --> Step3
    Step3["<div style='font-size: 19px; font-weight: 700; color: #DC2626 !important; margin-bottom: 6px;'>Step 3 · Picking the Targets</div><div style='font-size: 14px; color: #374151;'>Neural networks predict which mutations will most effectively trigger an immune response based on the patient's HLA receptors.<br><b>Software:</b> pVACseq running MHCflurry neural networks</div>"]
    Step3 --> NodeIn4
    ...
    %% Step 4
    NodeIn4 --> Step4
    Step4["<div style='font-size: 19px; font-weight: 700; color: #DC2626 !important; margin-bottom: 16px;'>Step 4 · Writing the New Code</div><div style='font-size: 14px; color: #374151;'>Strings targets together, adds structural instructions (5' Cap, Poly-A tail), and optimizes codons for folding stability.<br><b>Software:</b> pVACvector + LinearDesign</div>"]
    Step4 --> NodeIn5
    ...
    Title2 ~~~ Step5
    NodeIn5 --> Step5
    Step5["<div style='font-size: 19px; font-weight: 700; color: #DC2626 !important; margin-bottom: 6px;'>Step 5 · Printing the Master Copy</div><div style='font-size: 14px; color: #374151;'>Automated Gibson Assembly stitches synthetic oligonucleotides into a complete DNA plasmid, which is then linearized with restriction enzymes.<br><b>Hardware:</b> Benchtop DNA Synthesizer (e.g., Telesis Bio BioXp, ~$100k)<br><b>Cost:</b> ~$600 / rxn</div>"]
    Step5 --> NodeIn6
    ...
    NodeIVT -.-> Step6
    NodeIn6 --> Step6
    Step6["<div style='font-size: 19px; font-weight: 700; color: #DC2626 !important; margin-bottom: 6px;'>Step 6 · Mass Production</div><div style='font-size: 14px; color: #374151;'>Continuous-flow In Vitro Transcription (IVT) bioreactors read the DNA and print the corresponding mRNA strand.<br><b>Hardware:</b> NTxscribe System / Telesis Bio BioXp (~$250k / ~$100k)<br><b>Cost:</b> ~$2,000 / rxn</div>"]
    Step6 --> NodeIn7
    ...
    NodeLipids -.-> Step7
    NodeIn7 --> Step7
    Step7["<div style='font-size: 19px; font-weight: 700; color: #DC2626 !important; margin-bottom: 6px;'>Step 7 · Packaging for Delivery</div><div style='font-size: 14px; color: #374151;'>Precise microfluidic collisions force the negatively charged mRNA and positively charged lipids to self-assemble into nanoparticles.<br><b>Hardware:</b> Unchained Labs Sunshine / NanoAssemblr Ignite / Spark (~$150k / ~$150k)<br><b>Cost:</b> ~$500 / rxn</div>"]
    Step7 --> NodeIn8
    NodeIn8(["<div style='font-size: 15px; font-weight: 600;'>🧪 12 mL Raw mRNA-LNP mixture</div>"])
    
    %% Step 8
    NodeIn8 --> Step8
    Step8["<div style='font-size: 19px; font-weight: 700; color: #DC2626 !important; margin-bottom: 6px;'>Step 8 · Quality Check & Bottling</div><div style='font-size: 14px; color: #374151;'>Dynamic Light Scattering verifies particles are exactly 60-100nm and Tangential Flow Filtration washes out the toxic ethanol used during mixing.<br><b>Hardware:</b> Unchained Labs Stunner (~$80k) & TFF System<br><b>Cost:</b> ~$100 / rxn</div>"]
    Step8 --> NodeEnd
    NodeEnd(["<div style='font-size: 15px; font-weight: 600;'>💊 10 x 1.0 mL Vaccine Vials</div>"])

    classDef StepViolet fill:#F5F3FF,stroke:#8B5CF6,stroke-width:2px,text-align:left,color:#4C1D95;
    classDef StepTeal fill:#F0FDFA,stroke:#14B8A6,stroke-width:2px,text-align:left,color:#134E4A;
    ...
    class Step1,Step2,Step3,Step4 StepViolet;
    class Step5,Step6,Step7,Step8 StepTeal;
